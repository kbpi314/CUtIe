############################
# Kbpi's Analysis Notebook #
############################


###
# Installation and setting PYTHONPATH
###
...
echo "module load R && Rscript /sc/hydra/work/buk02/CUTIE/scripts/new_simulations.R --n_samp 25,50,100 --max_seed 19 --start 0 --stop 0.95 --step 0.05 --output '/sc/hydra/work/buk02/new_simulations/'" > /sc/hydra/work/buk02/new_commands/gen_sims.txt

python /sc/hydra/work/buk02/CUTIE/scripts/generate_lsf_chimera.py -c /sc/hydra/work/buk02/new_commands/gen_sims.txt -N gen_sims -o /sc/hydra/work/buk02/new_commands/ -n 2 -w 1:00 -s True


# job for generating configs
echo "module load python/3.7.3 && export PYTHONPATH=\$PYTHONPATH:/hpc/users/buk02/tools/sandbox/lib/python3.7/site-packages/ && for s in kpc ksc kkc rpc rsc rkc; do for v in 1 10; do for n in 25 50 100; do for c in True False; do python /sc/hydra/work/buk02/CUTIE/scripts/gen_commands_configs.py -m nomc -mpfp /sc/hydra/work/buk02/MIC_MSQ/mine_pvals/n=\$n,alpha=0.6.csv -fv \$v -s \$s -c \$c -w /sc/hydra/scratch/buk02/new_simulations/ -i /sc/hydra/work/buk02/new_simulations/ -o /sc/hydra/work/buk02/new_configs/; done; done; done; done;" > /sc/hydra/work/buk02/new_commands/gen_configs.txt
...
# job for running commands
echo "module load python/3.7.3 && export PYTHONPATH=\$PYTHONPATH:/hpc/users/buk02/tools/sandbox/lib/python3.7/site-packages/ && for file in /sc/hydra/work/buk02/new_configs/*/commands*.txt; do python /sc/hydra/work/buk02/CUTIE/scripts/generate_lsf_chimera.py -c \$file -N \${file##*/} -o \${file%/*} -n 2 -w 1:00 -s True; done" > /sc/hydra/work/buk02/new_commands/run_cutie.txt
...
echo "module load python/3.7.3 && export PYTHONPATH=\$PYTHONPATH:/hpc/users/buk02/tools/sandbox/lib/python3.7/site-packages/ && python /sc/hydra/work/buk02/CUTIE/scripts/analyze_simulations.py -fv 1,10 -s kpc,ksc,kkc,mine,rpc,rsc,rkc,rmine -m nomc -c False,True -cl FN,NP,FP,CD -nse 20 -nsa 25,50,100 -rn 0,0.95,0.05 -i /sc/hydra/scratch/buk02/new_simulations/ -o /sc/hydra/work/buk02/plots/" > /sc/hydra/work/buk02/new_commands/analyze_sims.txt

python /sc/hydra/work/buk02/CUTIE/scripts/generate_lsf_chimera.py -c /sc/hydra/work/buk02/new_commands/analyze_sims.txt -N analyze_sims -o /sc/hydra/work/buk02/new_commands/ -n 2 -w 4:00 -s True



# REAL DATA
# gen commands and configs
mkdir /sc/hydra/work/buk02/real_data_analysis/
mkdir /sc/hydra/scratch/buk02/real_data_analysis/
echo "module load python/3.7.3 && export PYTHONPATH=\$PYTHONPATH:/hpc/users/buk02/tools/sandbox/lib/python3.7/site-packages/ && for s in kpc; do for v in 1 10; do for m in fdr nomc; do for c in True False; do python /sc/hydra/work/buk02/CUTIE/scripts/gen_real_commands_configs.py -m \$m -fv \$v -s \$s -c \$c -w /sc/hydra/scratch/buk02/real_data_analysis/ -o /sc/hydra/work/buk02/real_data_analysis/; done; done; done; done;" > /sc/hydra/work/buk02/new_commands/gen_real_configs.txt

python /sc/hydra/work/buk02/CUTIE/scripts/generate_lsf_chimera.py -c /sc/hydra/work/buk02/new_commands/gen_real_configs.txt -N gen_real_configs -o /sc/hydra/work/buk02/new_commands/ -n 2 -w 2:00 -s True


# running commands
echo "module load python/3.7.3 && export PYTHONPATH=\$PYTHONPATH:/hpc/users/buk02/tools/sandbox/lib/python3.7/site-packages/ && for file in /sc/hydra/work/buk02/real_data_analysis/*/commands*.txt; do python /sc/hydra/work/buk02/CUTIE/scripts/generate_lsf_chimera.py -c \$file -N \${file##*/} -o \${file%/*} -n 2 -w 2:00 -s True; done" > /sc/hydra/work/buk02/new_commands/run_real_cutie.txt

python /sc/hydra/work/buk02/CUTIE/scripts/generate_lsf_chimera.py -c /sc/hydra/work/buk02/new_commands/run_real_cutie.txt -N run_real_cutie -o /sc/hydra/work/buk02/new_commands/ -n 4 -w 24:00 -s True
...
# filt 1k
filter_samples_from_otu_table.py -i /sc/hydra/work/buk02/transferlearning/MOMSPI_fecal/outputs/merged_otu_table.biom  -o /sc/hydra/work/buk02/transferlearning/MOMSPI_fecal/outputs/merged_otu_table_filt1000.biom -n 1000

# no singletons
filter_otus_from_otu_table.py -i /sc/hydra/work/buk02/transferlearning/MOMSPI_fecal/outputs/merged_otu_table_filt1000.biom -o /sc/hydra/work/buk02/transferlearning/MOMSPI_fecal/outputs/merged_otu_table_filt1000_nosingletons.biom -n 2

# summarize L5-7
summarize_taxa.py -i /sc/hydra/work/buk02/transferlearning/MOMSPI_fecal/outputs/merged_otu_table_filt1000_nosingletons.biom -o /sc/hydra/work/buk02/transferlearning/MOMSPI_fecal/outputs/ -L 5,6,7
...
###
# MOMSPI fecal vaginal and rectal I think
###
...
echo "module load anaconda2 && source activate qiime1.9.1 && export PYTHONPATH=/hpc/packages/minerva-centos7/anaconda2/2019.03/pkgs && beta_diversity_through_plots.py -i /sc/hydra/work/buk02/transferlearning/HMP/MOMSPI/outputs/merged_otu_table_filt1000_nosingletons.biom -o /sc/hydra/work/buk02/transferlearning/HMP/MOMSPI/bdiv/ -m /sc/hydra/work/buk02/transferlearning/HMP/MOMSPI/outputs/HMP_dummy_map.txt -e 1000 -a -O 20 -t /sc/orga/projects/clemej05a/data/gg_13_8_otus/trees/97_otus.tree" > /sc/hydra/work/buk02/transferlearning/HMP/MOMSPI/outputs/bdiv_commands.txt

python /sc/hydra/work/buk02/CUTIE/scripts/generate_lsf_chimera.py -c /sc/hydra/work/buk02/transferlearning/HMP/MOMSPI/outputs/bdiv_commands.txt -o /sc/hydra/work/buk02/transferlearning/HMP/MOMSPI/outputs/ -N bdiv -n 4 -w 96:00 -s True

###
# Transfer learning AG
###
...
echo "module load anaconda2 && source activate qiime1.9.1 && export PYTHONPATH=/hpc/packages/minerva-centos7/anaconda2/2019.03/pkgs && beta_diversity_through_plots.py -i /sc/hydra/work/buk02/transferlearning/AG/otu_table_no_singletons_filt1000.biom -o /sc/hydra/work/buk02/transferlearning/AG/bdiv/ -m /sc/hydra/work/buk02/transferlearning/AG/qiime_mapping_file.tsv -e 1000 -a -O 20 -t /sc/orga/projects/clemej05a/data/gg_13_8_otus/trees/97_otus.tree" > /sc/hydra/work/buk02/transferlearning/AG/bdiv_commands.txt

python /sc/hydra/work/buk02/CUTIE/scripts/generate_lsf_chimera.py -c /sc/hydra/work/buk02/transferlearning/AG/bdiv_commands.txt -o /sc/hydra/work/buk02/transferlearning/AG/ -N bdiv -n 4 -w 96:00 -s True



### TBD ADIV / BDIV Z SCORES / SPARCC
...
do
f=${file##*/}
echo "module purge && module load metaphlan/097a52362c79 && module load samtools/0.1.19 && module load muscle && module load raxml && module load blast && metaphlan2.py $file /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/${f}_profile.txt --bowtie2out /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/${f}_bowtie2.txt --samout /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/${f}.sam.bz2 --input_type multifastq --bowtie2db /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/METAPHLAN_BOWTIE2_DB && sample2markers.py --ifn_samples /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/${f}.sam.bz2 --input_type sam --output_dir /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/" > /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/${f}_commands.txt;
done
...
do
f=${file##*/}
python /sc/hydra/projects/clemej05a/buk02/CUTIE/scripts/generate_lsf_chimera.py -c /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/${f}_commands.txt -N ${f} -o /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/ -n 4 -w 96:00 -s True
done
...
strainphlan.py --ifn_samples /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/*.markers --output_dir /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/ --print_clades_only > /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/clades.txt

mkdir /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/db_markers/
bowtie2-inspect /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/METAPHLAN_BOWTIE2_DB/mpa_v20_m200 > /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/db_markers/all_markers.fasta



while read p; do
    mkdir /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/$p
    extract_markers.py --mpa_pkl /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/METAPHLAN_BOWTIE2_DB/mpa_v20_m200.pkl --ifn_markers /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/db_markers/all_markers.fasta --clade $p --ofn_markers /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/db_markers/${p}.markers.fasta
    strainphlan.py --ifn_samples /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/*.markers --ifn_markers /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/db_markers/${p}.markers.fasta --output_dir /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/${p}/ --clades $p --marker_in_clade 0.8
done < /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/clades.txt
...
# metaphlan per sample

for file in /sc/orga/projects/clemej05a/FOCUS/inputs/australian_data.full.cat/*R1*;
do
f=${file##*/}
echo "module purge && module load metaphlan/097a52362c79 && module load samtools/0.1.19 && module load muscle && module load raxml && module load blast && metaphlan2.py $file /sc/hydra/projects/clemej05a/buk02/FOCUS/R1/${f}_profile.txt --bowtie2out /sc/hydra/projects/clemej05a/buk02/FOCUS/R1/${f}_bowtie2.txt --samout /sc/hydra/projects/clemej05a/buk02/FOCUS/R1/${f}.sam.bz2 --input_type multifastq --bowtie2db /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/METAPHLAN_BOWTIE2_DB && sample2markers.py --ifn_samples /sc/hydra/projects/clemej05a/buk02/FOCUS/R1/${f}.sam.bz2 --input_type sam --output_dir /sc/hydra/projects/clemej05a/buk02/FOCUS/R1/" > /sc/hydra/projects/clemej05a/buk02/FOCUS/R1/${f}_commands.txt;
python /sc/hydra/work/buk02/CUTIE/scripts/generate_lsf_chimera.py -c /sc/hydra/projects/clemej05a/buk02/FOCUS/R1/${f}_commands.txt -N ${f} -o /sc/hydra/projects/clemej05a/buk02/FOCUS/R1/ -n 4 -w 96:00 -s True
done


# strainphlan analysis
echo "ml metaphlan/097a52362c79 && ml samtools/0.1.19 && ml muscle && ml raxml && ml blast && strainphlan.py --ifn_samples /sc/hydra/projects/clemej05a/buk02/FOCUS/R1/*.markers --output_dir /sc/hydra/projects/clemej05a/buk02/FOCUS/R1/ --print_clades_only > /sc/hydra/projects/clemej05a/buk02/FOCUS/R1/trees/clades.txt" > /sc/hydra/projects/clemej05a/buk02/FOCUS/R1/commands/strain_commands.txt

python /sc/hydra/work/buk02/CUTIE/scripts/generate_lsf_chimera.py -c /sc/hydra/projects/clemej05a/buk02/FOCUS/R1/commands/strain_commands.txt -N strain_commands -o /sc/hydra/projects/clemej05a/buk02/FOCUS/R1/commands/ -n 2 -w 4:00 -s True


# strain-specific profiling
mkdir /sc/hydra/projects/clemej05a/buk02/FOCUS/R1/db_markers
cp /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/db_markers/all_markers.fasta /sc/hydra/projects/clemej05a/buk02/FOCUS/R1/db_markers/

echo "ml metaphlan/097a52362c79 && ml samtools/0.1.19 && ml muscle && ml raxml && ml blast && while read p; do mkdir /sc/hydra/projects/clemej05a/buk02/FOCUS/R1/\$p && extract_markers.py --mpa_pkl /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/METAPHLAN_BOWTIE2_DB/mpa_v20_m200.pkl --ifn_markers /sc/hydra/projects/clemej05a/buk02/FOCUS/R1/db_markers/all_markers.fasta --clade \$p --ofn_markers /sc/hydra/projects/clemej05a/buk02/FOCUS/R1/db_markers/\${p}.markers.fasta && strainphlan.py --ifn_samples /sc/hydra/projects/clemej05a/buk02/FOCUS/R1/*.markers --ifn_markers /sc/hydra/projects/clemej05a/buk02/FOCUS/R1/db_markers/\${p}.markers.fasta --output_dir /sc/hydra/projects/clemej05a/buk02/FOCUS/R1/trees/${p}/ --clades \$p --marker_in_clade 0.8; done < /sc/hydra/projects/clemej05a/buk02/FOCUS/R1/trees/clades.txt" > /sc/hydra/projects/clemej05a/buk02/FOCUS/R1/commands/tree_commands.txt

python /sc/hydra/work/buk02/CUTIE/scripts/generate_lsf_chimera.py -c /sc/hydra/projects/clemej05a/buk02/FOCUS/R1/commands/tree_commands.txt -N tree_commands -o /sc/hydra/projects/clemej05a/buk02/FOCUS/R1/commands/ -n 4 -w 24:00 -s True
...
do
f=${file##*/}
echo "module purge && module load metaphlan/097a52362c79 && module load samtools/0.1.19 && module load muscle && module load raxml && module load blast && metaphlan2.py $file /sc/hydra/projects/clemej05a/buk02/FOCUS/R2/${f}_profile.txt --bowtie2out /sc/hydra/projects/clemej05a/buk02/FOCUS/R2/${f}_bowtie2.txt --samout /sc/hydra/projects/clemej05a/buk02/FOCUS/R2/${f}.sam.bz2 --input_type multifastq --bowtie2db /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/METAPHLAN_BOWTIE2_DB && sample2markers.py --ifn_samples /sc/hydra/projects/clemej05a/buk02/FOCUS/R2/${f}.sam.bz2 --input_type sam --output_dir /sc/hydra/projects/clemej05a/buk02/FOCUS/R2/" > /sc/hydra/projects/clemej05a/buk02/FOCUS/R2/${f}_commands.txt;
python /sc/hydra/work/buk02/CUTIE/scripts/generate_lsf_chimera.py -c /sc/hydra/projects/clemej05a/buk02/FOCUS/R2/${f}_commands.txt -N ${f} -o /sc/hydra/projects/clemej05a/buk02/FOCUS/R2/ -n 4 -w 96:00 -s True
done


# strainphlan analysis
echo "ml metaphlan/097a52362c79 && ml samtools/0.1.19 && ml muscle && ml raxml && ml blast && strainphlan.py --ifn_samples /sc/hydra/projects/clemej05a/buk02/FOCUS/R2/*.markers --output_dir /sc/hydra/projects/clemej05a/buk02/FOCUS/R2/ --print_clades_only > /sc/hydra/projects/clemej05a/buk02/FOCUS/R2/trees/clades.txt" > /sc/hydra/projects/clemej05a/buk02/FOCUS/R2/commands/strain_commands.txt

python /sc/hydra/work/buk02/CUTIE/scripts/generate_lsf_chimera.py -c /sc/hydra/projects/clemej05a/buk02/FOCUS/R2/commands/strain_commands.txt -N strain_commands -o /sc/hydra/projects/clemej05a/buk02/FOCUS/R2/commands/ -n 2 -w 4:00 -s True


# strain-specific profiling
mkdir /sc/hydra/projects/clemej05a/buk02/FOCUS/R2/db_markers
cp /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/db_markers/all_markers.fasta /sc/hydra/projects/clemej05a/buk02/FOCUS/R2/db_markers/

echo "ml metaphlan/097a52362c79 && ml samtools/0.1.19 && ml muscle && ml raxml && ml blast && while read p; do mkdir /sc/hydra/projects/clemej05a/buk02/FOCUS/R2/\$p && extract_markers.py --mpa_pkl /sc/hydra/projects/clemej05a/buk02/strainphlan_analysis/METAPHLAN_BOWTIE2_DB/mpa_v20_m200.pkl --ifn_markers /sc/hydra/projects/clemej05a/buk02/FOCUS/R2/db_markers/all_markers.fasta --clade \$p --ofn_markers /sc/hydra/projects/clemej05a/buk02/FOCUS/R2/db_markers/\${p}.markers.fasta && strainphlan.py --ifn_samples /sc/hydra/projects/clemej05a/buk02/FOCUS/R2/*.markers --ifn_markers /sc/hydra/projects/clemej05a/buk02/FOCUS/R2/db_markers/\${p}.markers.fasta --output_dir /sc/hydra/projects/clemej05a/buk02/FOCUS/R2/trees/${p}/ --clades \$p --marker_in_clade 0.8; done < /sc/hydra/projects/clemej05a/buk02/FOCUS/R2/trees/clades.txt" > /sc/hydra/projects/clemej05a/buk02/FOCUS/R2/commands/tree_commands.txt

python /sc/hydra/work/buk02/CUTIE/scripts/generate_lsf_chimera.py -c /sc/hydra/projects/clemej05a/buk02/FOCUS/R2/commands/tree_commands.txt -N tree_commands -o /sc/hydra/projects/clemej05a/buk02/FOCUS/R2/commands/ -n 4 -w 24:00 -s True
