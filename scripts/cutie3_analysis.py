...
paths = glob('/sc/hydra/work/buk02/data_analysis/sim*') + \
glob('/sc/hydra/work/buk02/data_analysis/cutie_WHO*') + \
glob('/sc/hydra/work/buk02/data_analysis/cutie_hdac*') + \
glob('/sc/hydra/work/buk02/data_analysis/cutie_lungc*')
...
for path in paths:
    ...
    #call(["sed -i 's,,,g' " + cutie_path], shell = True)
