...
__author__ = "Kevin Bu"
__copyright__ = "Copyright 2019, The CUTIE project"
...
@click.option('-m', '--modules', default='',
              help='Module(s) to load, comma-separated', required=False)
@click.option('-M', '--memory', default=4000,
              help='Memory', required=False)
@click.option('-V', '--versions', default='',
